...
class ModalSignUp extends React.Component {
  static propTypes = {
    showModalSignUp: PropTypes.bool,
    closeModalSignUp: PropTypes.func,
    switchModal: PropTypes.func
  };

  static defaultProps = {
    showModalSignUp: false,
    closeModalSignUp: null,
    switchModal: null
  };
  ...
  render() {
    return (
      <Modal
        isOpen={this.props.showModalSignUp}
        contentLabel="Join Qubicle"
        onRequestClose={this.props.closeModalSignUp}
      ...
      >
        <div className={s.ReactModal__ContentSignUp}>
          <button
            className={s.closeModal}
            type="button"
            onClick={this.props.closeModalSignUp}
          >
          ...
          <h3>
            ...
            interests and authors, like stories you love, and more.
          </h3>
          ...
          <span>
            ...
            providers. Click &ldquo;Sign up&rdquo; above to accept
...
export default withStyles(s)(ModalSignUp);
